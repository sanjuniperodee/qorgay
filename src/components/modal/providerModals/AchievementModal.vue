...
import { useAchievementForm } from '@components/forms/providerForms/useAchievementForm'
    ...
    <div class="modal">
      <form @submit.prevent="handleSubmit">
        ...
        <div class="statement-list">
          <v-text-field
            v-model="achievement.certificate_name"
            label="Название сертификата"
            :rules="[rules.required]"
          ></v-text-field>

          <v-text-field
            v-model.number="achievement.year_received"
            label="Год достижения"
            type="number"
            :rules="[rules.required, rules.isNumber]"
          ></v-text-field>

          <MediaUpload v-if="!uploadedFile" :title="'Фото Сертификата'" :handleFileChange="handleFileChange"/>
