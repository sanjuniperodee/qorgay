...
import { useExperienceForm } from '@components/forms/providerForms/useExperienceForm'
      ...
      <form @submit.prevent="handleSubmit">
        ...
        <div class="statement-list">
          ...
          <div class="year-average">
            <v-text-field
              v-model.number="experience.year_start"
              label="Год начала"
              type="number"
            ...
            <v-text-field
              v-if="!performingNow"
              v-model.number="experience.year_end"
              label="Год окончания"
              type="number"
              :rules="[rules.required, rules.isNumber]"
            ></v-text-field>
