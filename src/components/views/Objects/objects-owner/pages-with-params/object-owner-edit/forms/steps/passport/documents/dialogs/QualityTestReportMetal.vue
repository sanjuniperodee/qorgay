      ...
      <v-card-item>
        ...
        >
          ...
          >
            ...
            <v-text-field
              v-model="item.observationLocations"
              label="Места наблюдений и измерений огнезащитного покрытия"
              placeholder="Введите места наблюдений и измерений"
              style="min-width: 450px; padding-left: 20px"
            ></v-text-field>

            <v-text-field
              v-model="item.fireproofCoatingThickness"
              label="Толщина огнезащитного покрытия, мм"
              placeholder="Введите толщину огнезащитного покрытия, мм"
              style="min-width: 450px; padding-left: 20px"
            ></v-text-field>
...
type resultItem = {
  observationLocations: string
  fireproofCoatingThickness: string
  testResults: string
}
